...
use crate::{
    alias::PaymentsManagerType, anonymize_path,
    channel_manager::NodeChannelManager, client::NodeLspClient,
    persister::NodePersister, runner::UserRunnerCommand,
};
...
async fn do_handle_event(
    ...
    match event {
        ...
        Event::PaymentPathSuccessful {
            ...
            let maybe_event = anonymize_path::successful_path(
                &ctx.network_graph,
                payment_id,
                payment_hash,
                path,
        ...
        Event::PaymentPathFailed {
            ...
            let maybe_event = anonymize_path::failed_path(
                &ctx.network_graph,
                payment_id,
                payment_hash,
                payment_failed_permanently,
