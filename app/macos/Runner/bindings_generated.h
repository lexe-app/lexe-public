...
typedef struct wire_PreflightPayOnchainRequest {
  struct wire_uint_8_list *address;
  uint64_t amount_sats;
} wire_PreflightPayOnchainRequest;
...
typedef struct wire_PreflightPayInvoiceRequest {
  struct wire_uint_8_list *invoice;
  uint64_t *fallback_amount_sats;
} wire_PreflightPayInvoiceRequest;
...
void wire_preflight_pay_invoice__method__AppHandle(int64_t port_,
                                                   struct wire_AppHandle *that,
                                                   struct wire_PreflightPayInvoiceRequest *req);
