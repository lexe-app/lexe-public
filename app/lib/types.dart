...
class BalanceState {
  const BalanceState({required this.balanceSats, required this.fiatRate});

  final Balance? balanceSats;
  final FiatRate? fiatRate;

  static const BalanceState placeholder = BalanceState(
    balanceSats: null,
    fiatRate: null,
  );
  ...
  @override
  int get hashCode => Object.hash(this.balanceSats, this.fiatRate);
  ...
  bool operator ==(Object other) =>
      ...
      other is BalanceState &&
          this.runtimeType == other.runtimeType &&
          this.balanceSats == other.balanceSats &&
          this.fiatRate == other.fiatRate;

  @override
  String toString() =>
      'BalanceState(balanceSats: ${this.balanceSats}, '
