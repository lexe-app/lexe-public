...
class ReceivePaymentPage6 extends StatefulWidget {
  const ReceivePaymentPage6({super.key});

  @override
  State<ReceivePaymentPage6> createState() => ReceivePaymentPageState6();
}

class ReceivePaymentPageState6 extends State<ReceivePaymentPage6> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
      ...
      body: ScrollableSinglePageBody(
        ...
        body: [
          ...
          //       horizontal: Space.s600, vertical: Space.s200),
          //   child: ,
          // ),
          // const SubheadingText(text: "Unified Bitcoin and Lightning QR code"),
          const SizedBox(height: Space.s500),
          ...
          SizedBox(
            ...
            child: LayoutBuilder(builder: (context, constraints) {
              info("LayoutBuilder: constraints: $constraints");
              return PageView(
