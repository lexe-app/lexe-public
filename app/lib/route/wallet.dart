...
class WalletPageState extends State<WalletPage> {
  ...
  final BehaviorSubject<FiatRate?> fiatRates = BehaviorSubject.seeded(null);
  ...
  void initState() {
    ...
    Rx.combineLatest2(
      ...
      this.fiatRates.map((fiatRates) => fiatRates?.rate),
    ...
    refreshRx.asyncMap((_) => app.fiatRate(fiat: fiatName)).listen(
