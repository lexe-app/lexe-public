    ...
    return Future.delayed(
      ...
      () => CreateOfferResponse(
        offer: Offer(
          ...
          expiresAt: expiresAt,
          minAmountSats: req.minAmountSats,
          description: req.description,
        ),
      ),
    );
...
List<Payment> appStoreWalletPayments({DateTime? now}) {
  ...
  return <Payment>[
    Payment(
      ...
      amountSats: appStoreWalletInitialLexeDepositSats,
      feesSats: 0,
      amountMsats: appStoreWalletInitialLexeDepositSats * 1000,
      feesMsats: 0,
    ...
    Payment(
      ...
      amountSats: appStoreWalletStackerNewsSendSats,
      feesSats: 0,
      amountMsats: appStoreWalletStackerNewsSendSats * 1000,
      feesMsats: 0,
      status: PaymentStatus.completed,
      statusStr: "completed",
    ...
    Payment(
      ...
      amountSats: appStoreWalletLunchAtCeciliasReceiveSats,
      feesSats: 0,
      amountMsats: appStoreWalletLunchAtCeciliasReceiveSats * 1000,
      feesMsats: 0,
      status: PaymentStatus.completed,
      statusStr: "completed",
...
const Payment dummySpontaneousOutboundPending01 = Payment(
  ...
  direction: PaymentDirection.outbound,
  amountSats: 123456,
  feesSats: 123456 * 5 ~/ 1000,
  amountMsats: 123456 * 1000,
  feesMsats: 123456 * 5,
  status: PaymentStatus.pending,
  statusStr: "pending",
  personalNote: "😎⚡️🚀😩",
...
const Payment dummyInvoiceOutboundPending01 = Payment(
  ...
  amountSats: 3000,
  feesSats: 3000 * 5 ~/ 1000,
  amountMsats: 3000 * 1000,
  feesMsats: 3000 * 5,
  status: PaymentStatus.pending,
  statusStr: "pending",
  personalNote: null,
...
const Payment dummyLnInvoiceInboundPendingToComplete = Payment(
  ...
  amountSats: 471700 * 995 ~/ 1000,
  feesSats: 471700 * 5 ~/ 1000,
  amountMsats: 471700 * 995,
  feesMsats: 471700 * 5,
  status: PaymentStatus.pending,
  statusStr: "claiming",
  personalNote:
...
const Payment dummyInvoiceInboundCompleted01 = Payment(
  ...
  amountSats: 223466 * 995 ~/ 1000,
  feesSats: 223466 * 5 ~/ 1000,
  amountMsats: 223466 * 995,
  feesMsats: 223466 * 5,
  status: PaymentStatus.completed,
  statusStr: "completed",
  personalNote: null,
...
const Payment dummyInvoiceInboundCompleted02 = Payment(
  ...
  amountSats: 32166 * 995 ~/ 1000,
  feesSats: 32166 * 5 ~/ 1000,
  amountMsats: 32166 * 995,
  feesMsats: 32166 * 5,
  status: PaymentStatus.completed,
  statusStr: "completed",
...
const Payment dummyInvoiceInboundCompleted03 = Payment(
  ...
  amountSats: 60000 * 995 ~/ 1000,
  feesSats: 60000 * 5 ~/ 1000,
  amountMsats: 60000 * 995,
  feesMsats: 60000 * 5,
  status: PaymentStatus.completed,
  statusStr: "completed",
...
const Payment dummyInvoiceOutboundCompleted01 = Payment(
  ...
  amountSats: 7000,
  feesSats: 7000 * 5 ~/ 1000,
  amountMsats: 7000 * 1000,
  feesMsats: 7000 * 5,
  status: PaymentStatus.completed,
  statusStr: "completed",
  personalNote: "stacker.news",
...
const Payment dummyOfferOutboundPayment01 = Payment(
  ...
  amountSats: 33000,
  feesSats: 33000 * 5 ~/ 1000,
  amountMsats: 33000 * 1000,
  feesMsats: 33000 * 5,
  status: PaymentStatus.completed,
  statusStr: "completed",
...
const Payment dummyOfferInboundPayment01 = Payment(
  ...
  offer: null,
  amountSats: 59700 * 995 ~/ 1000,
  feesSats: 59700 * 5 ~/ 1000,
  amountMsats: 59700 * 995,
  feesMsats: 59700 * 5,
  status: PaymentStatus.completed,
  statusStr: "completed",
