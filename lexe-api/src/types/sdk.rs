...
use common::{
    ...
    ln::{
        ...
        invoice::LxInvoice,
        payments::{
            LxPaymentHash, LxPaymentSecret, PaymentDirection, PaymentIndex,
...
pub struct SdkNodeInfo {
    ...
    /// The measurement is basically the hash of the enclave binary.
...
impl From<common::api::command::NodeInfo> for SdkNodeInfo {
