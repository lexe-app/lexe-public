...
impl SseDecode for crate::ffi::types::Config {
    ...
    fn sse_decode(
        ...
        let mut var_lexeDbDir = <String>::sse_decode(deserializer);
...
impl flutter_rust_bridge::IntoDart for crate::ffi::types::Config {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            ...
            self.lexe_db_dir.into_into_dart().into_dart(),
...
impl SseEncode for crate::ffi::types::Config {
    ...
    fn sse_encode(
        ...
        <String>::sse_encode(self.lexe_db_dir, serializer);
