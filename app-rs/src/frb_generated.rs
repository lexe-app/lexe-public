...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1619600457;
...
fn wire__crate__ffi__app__app_handle_app_db_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "app_handle_app_db", port: None, mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_that = <crate::ffi::app::AppHandle>::sse_decode(&mut deserializer);deserializer.end();
                transform_result_sse::<_, ()>((move || {
                     let output_ok = Result::<_,()>::Ok(crate::ffi::app::AppHandle::app_db(&api_that))?;   Ok(output_ok)
                })()) })
}
...
impl SseDecode for Option<crate::ffi::types::Username> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(
        deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer,
    ) -> Self {
...
6 => wire__crate__ffi__app__app_handle_close_channel_impl(port, ptr, rust_vec_len, data_len),
7 => wire__crate__ffi__app__app_handle_create_client_impl(port, ptr, rust_vec_len, data_len),
8 => wire__crate__ffi__app__app_handle_create_invoice_impl(port, ptr, rust_vec_len, data_len),
9 => wire__crate__ffi__app__app_handle_create_offer_impl(port, ptr, rust_vec_len, data_len),
...
22 => wire__crate__ffi__app__app_handle_get_payment_address_impl(port, ptr, rust_vec_len, data_len),
31 => wire__crate__ffi__app__app_handle_get_vec_idx_by_payment_index_impl(port, ptr, rust_vec_len, data_len),
32 => wire__crate__ffi__app__app_handle_list_broadcasted_txs_impl(port, ptr, rust_vec_len, data_len),
33 => wire__crate__ffi__app__app_handle_list_channels_impl(port, ptr, rust_vec_len, data_len),
34 => wire__crate__ffi__app__app_handle_list_clients_impl(port, ptr, rust_vec_len, data_len),
35 => wire__crate__ffi__app__app_handle_load_impl(port, ptr, rust_vec_len, data_len),
36 => wire__crate__ffi__app__app_handle_node_info_impl(port, ptr, rust_vec_len, data_len),
37 => wire__crate__ffi__app__app_handle_open_channel_impl(port, ptr, rust_vec_len, data_len),
38 => wire__crate__ffi__app__app_handle_pay_invoice_impl(port, ptr, rust_vec_len, data_len),
...
41 => wire__crate__ffi__app__app_handle_preflight_close_channel_impl(port, ptr, rust_vec_len, data_len),
42 => wire__crate__ffi__app__app_handle_preflight_open_channel_impl(port, ptr, rust_vec_len, data_len),
43 => wire__crate__ffi__app__app_handle_preflight_pay_invoice_impl(port, ptr, rust_vec_len, data_len),
44 => wire__crate__ffi__app__app_handle_preflight_pay_offer_impl(port, ptr, rust_vec_len, data_len),
45 => wire__crate__ffi__app__app_handle_preflight_pay_onchain_impl(port, ptr, rust_vec_len, data_len),
46 => wire__crate__ffi__app__app_handle_provision_impl(port, ptr, rust_vec_len, data_len),
47 => wire__crate__ffi__app__app_handle_resolve_best_impl(port, ptr, rust_vec_len, data_len),
48 => wire__crate__ffi__app__app_handle_resolve_lnurl_pay_request_impl(port, ptr, rust_vec_len, data_len),
49 => wire__crate__ffi__app__app_handle_restore_impl(port, ptr, rust_vec_len, data_len),
...
53 => wire__crate__ffi__app__app_handle_update_client_impl(port, ptr, rust_vec_len, data_len),
54 => wire__crate__ffi__app__app_handle_update_payment_address_impl(port, ptr, rust_vec_len, data_len),
55 => wire__crate__ffi__app__app_handle_update_payment_note_impl(port, ptr, rust_vec_len, data_len),
...
4 => wire__crate__ffi__app__app_handle_app_db_impl(ptr, rust_vec_len, data_len),
13 => wire__crate__ffi__app__app_handle_get_finalized_not_junk_short_payment_by_scroll_idx_impl(ptr, rust_vec_len, data_len),
14 => wire__crate__ffi__app__app_handle_get_finalized_not_junk_short_payment_by_scroll_index_impl(ptr, rust_vec_len, data_len),
15 => wire__crate__ffi__app__app_handle_get_finalized_short_payment_by_scroll_idx_impl(ptr, rust_vec_len, data_len),
...
24 => wire__crate__ffi__app__app_handle_get_payment_by_vec_idx_impl(ptr, rust_vec_len, data_len),
25 => wire__crate__ffi__app__app_handle_get_pending_not_junk_short_payment_by_scroll_idx_impl(ptr, rust_vec_len, data_len),
26 => wire__crate__ffi__app__app_handle_get_pending_not_junk_short_payment_by_scroll_index_impl(ptr, rust_vec_len, data_len),
27 => wire__crate__ffi__app__app_handle_get_pending_short_payment_by_scroll_idx_impl(ptr, rust_vec_len, data_len),
28 => wire__crate__ffi__app__app_handle_get_pending_short_payment_by_scroll_index_impl(ptr, rust_vec_len, data_len),
29 => wire__crate__ffi__app__app_handle_get_short_payment_by_scroll_idx_impl(ptr, rust_vec_len, data_len),
30 => wire__crate__ffi__app__app_handle_get_short_payment_by_scroll_index_impl(ptr, rust_vec_len, data_len),
50 => wire__crate__ffi__app__app_handle_settings_db_impl(ptr, rust_vec_len, data_len),
56 => wire__crate__ffi__app__app_handle_user_info_impl(ptr, rust_vec_len, data_len),
57 => wire__crate__ffi__types__client_payment_id_gen_new_impl(ptr, rust_vec_len, data_len),
58 => wire__crate__ffi__debug__delete_latest_provisioned_impl(ptr, rust_vec_len, data_len),
59 => wire__crate__ffi__debug__delete_secret_store_impl(ptr, rust_vec_len, data_len),
60 => wire__crate__ffi__types__deploy_env_from_str_impl(ptr, rust_vec_len, data_len),
...
76 => wire__crate__ffi__types__root_seed_from_sys_rng_impl(ptr, rust_vec_len, data_len),
...
impl SseEncode for Option<crate::ffi::types::Username> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(
        self,
        serializer: &mut flutter_rust_bridge::for_generated::SseSerializer,
