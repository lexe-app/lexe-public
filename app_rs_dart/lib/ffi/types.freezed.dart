...
mixin _$Offer {
 ...
 String get string; String? get description; int? get expiresAt; int? get minAmountSats; int? get bip321AmountSats; String? get humanBitcoinAddress; String? get payee; String? get payeePubkey;
...
@override
int get hashCode => Object.hash(runtimeType,string,description,expiresAt,minAmountSats,bip321AmountSats,humanBitcoinAddress,payee,payeePubkey);

@override
String toString() {
  return 'Offer(string: $string, description: $description, expiresAt: $expiresAt, minAmountSats: $minAmountSats, bip321AmountSats: $bip321AmountSats, humanBitcoinAddress: $humanBitcoinAddress, payee: $payee, payeePubkey: $payeePubkey)';
}
...
class _Offer implements Offer {
  const _Offer({required this.string, this.description, this.expiresAt, this.minAmountSats, this.bip321AmountSats, this.humanBitcoinAddress, this.payee, this.payeePubkey});
