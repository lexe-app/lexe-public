...
abstract class AppRsApi extends BaseApi {
  int crateFfiTypesHbaClaimMinBalanceSats();
  ...
  Future<String> crateFfiAppAppHandleBuyWithCashApp({
    required AppHandle that,
    required int amountSats,
  });

  Future<void> crateFfiAppAppHandleCancelPayment({
    required AppHandle that,
    required CancelPaymentRequest req,
  });
  ...
  Future<UserSettings> crateFfiAppAppHandleGetUserSettings({
    required AppHandle that,
  });
  ...
  Future<void> crateFfiAppAppHandleRevokeClient({
    required AppHandle that,
    required RevokeClientRequest req,
  });

  SettingsDb crateFfiAppAppHandleSettingsDb({required AppHandle that});

  Future<void> crateFfiAppAppHandleSetupGdrive({
    required AppHandle that,
  ...
  Future<UserSettings> crateFfiAppAppHandleUpdateUserSettings({
    required AppHandle that,
  ...
  Future<Payment> crateFfiAppAppHandleWithdrawLnurl({
    required AppHandle that,
    required WithdrawLnurlRequest req,
  });
  ...
  Future<void> crateFfiGdriveGDriveRestoreClientRotateBackupPassword({
    required GDriveRestoreClient that,
    required DeployEnv deployEnv,
    required Network network,
    required bool useSgx,
  ...
  String crateFfiTypesScopeToStringId({required Scope that});
...
class AppRsApiImpl extends AppRsApiImplPlatform implements AppRsApi {
  ...
  int crateFfiTypesHbaClaimMinBalanceSats() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateFfiTypesHbaClaimMinBalanceSatsConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFfiTypesHbaClaimMinBalanceSatsConstMeta =>
      const TaskConstMeta(
        debugName: "HBA_CLAIM_MIN_BALANCE_SATS",
        argNames: [],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_app_handle(that, serializer);
          sse_encode_CastedPrimitive_u_64(amountSats, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 7,
        ...
        constMeta: kCrateFfiAppAppHandleBuyWithCashAppConstMeta,
  ...
  TaskConstMeta get kCrateFfiAppAppHandleBuyWithCashAppConstMeta =>
      const TaskConstMeta(
        debugName: "app_handle_buy_with_cash_app",
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_app_handle(that, serializer);
          sse_encode_box_autoadd_cancel_payment_request(req, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 8,
        ...
        constMeta: kCrateFfiAppAppHandleCancelPaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFfiAppAppHandleCancelPaymentConstMeta =>
      const TaskConstMeta(
        debugName: "app_handle_cancel_payment",
        argNames: ["that", "req"],
      );
  ...
  Future<UserSettings> crateFfiAppAppHandleGetUserSettings({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateFfiAppAppHandleGetUserSettingsConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFfiAppAppHandleGetUserSettingsConstMeta =>
      const TaskConstMeta(
        debugName: "app_handle_get_user_settings",
        argNames: ["that"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_app_handle(that, serializer);
          sse_encode_box_autoadd_revoke_client_request(req, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 47,
        ...
        constMeta: kCrateFfiAppAppHandleRevokeClientConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFfiAppAppHandleRevokeClientConstMeta =>
      const TaskConstMeta(
        debugName: "app_handle_revoke_client",
        argNames: ["that", "req"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_app_handle(that, serializer);
          sse_encode_box_autoadd_g_drive_signup_credentials(
        ...
        constMeta: kCrateFfiAppAppHandleSetupGdriveConstMeta,
        argValues: [that, gdriveSignupCredentials],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateFfiAppAppHandleSetupGdriveConstMeta =>
      const TaskConstMeta(
        debugName: "app_handle_setup_gdrive",
        argNames: ["that", "gdriveSignupCredentials"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_app_handle(that, serializer);
          sse_encode_box_autoadd_update_user_settings_request(req, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 54,
        ...
        constMeta: kCrateFfiAppAppHandleUpdateUserSettingsConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFfiAppAppHandleUpdateUserSettingsConstMeta =>
      const TaskConstMeta(
        debugName: "app_handle_update_user_settings",
        argNames: ["that", "req"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_app_handle(that, serializer);
          sse_encode_box_autoadd_withdraw_lnurl_request(req, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 56,
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_payment,
          decodeErrorData: sse_decode_AnyhowException,
        ),
        constMeta: kCrateFfiAppAppHandleWithdrawLnurlConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFfiAppAppHandleWithdrawLnurlConstMeta =>
      const TaskConstMeta(
        debugName: "app_handle_withdraw_lnurl",
        argNames: ["that", "req"],
      );
  ...
  Future<void> crateFfiGdriveGDriveRestoreClientRotateBackupPassword({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateFfiGdriveGDriveRestoreClientRotateBackupPasswordConstMeta,
        argValues: [that, deployEnv, network, useSgx, rootSeed, newPassword],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateFfiGdriveGDriveRestoreClientRotateBackupPasswordConstMeta =>
      const TaskConstMeta(
        debugName: "g_drive_restore_client_rotate_backup_password",
        argNames: [
          "that",
          "deployEnv",
          "network",
  ...
  PaymentRail crateFfiTypesPaymentKindRail({required PaymentKind that}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateFfiTypesPaymentKindRailConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFfiTypesPaymentKindRailConstMeta =>
  ...
  String crateFfiTypesScopeToStringId({required Scope that}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateFfiTypesScopeToStringIdConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFfiTypesScopeToStringIdConstMeta =>
      const TaskConstMeta(debugName: "scope_to_string_id", argNames: ["that"]);
  ...
  AppData dco_decode_app_data(dynamic raw) {
    ...
    return AppData(
      humanBitcoinAddress:
          dco_decode_opt_box_autoadd_get_human_bitcoin_address_response(arr[0]),
      preferredFiatCurrency: dco_decode_opt_String(arr[1]),
    );
  }
  ...
  CancelPaymentRequest dco_decode_box_autoadd_cancel_payment_request(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_cancel_payment_request(raw);
  }
  ...
  dco_decode_box_autoadd_get_human_bitcoin_address_response(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_get_human_bitcoin_address_response(raw);
  }
  ...
  RevokeClientRequest dco_decode_box_autoadd_revoke_client_request(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_revoke_client_request(raw);
  }
  ...
  WithdrawLnurlRequest dco_decode_box_autoadd_withdraw_lnurl_request(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_withdraw_lnurl_request(raw);
  }
  ...
  CreateOfferRequest dco_decode_create_offer_request(dynamic raw) {
    ...
    return CreateOfferRequest(
      ...
      minAmountSats: dco_decode_opt_CastedPrimitive_u_64(arr[1]),
      description: dco_decode_opt_String(arr[2]),
  ...
  GetHumanBitcoinAddressResponse dco_decode_get_human_bitcoin_address_response(
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return GetHumanBitcoinAddressResponse(
      humanBitcoinAddress: dco_decode_String(arr[0]),
      lightningAddress: dco_decode_String(arr[1]),
      offer: dco_decode_offer(arr[2]),
  ...
  Offer dco_decode_offer(dynamic raw) {
    ...
    return Offer(
      ...
      minAmountSats: dco_decode_opt_CastedPrimitive_u_64(arr[3]),
      bip321AmountSats: dco_decode_opt_CastedPrimitive_u_64(arr[4]),
      humanBitcoinAddress: dco_decode_opt_String(arr[5]),
      payee: dco_decode_opt_String(arr[6]),
      payeePubkey: dco_decode_opt_String(arr[7]),
    );
  }
  ...
  dco_decode_opt_box_autoadd_get_human_bitcoin_address_response(dynamic raw) {
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_get_human_bitcoin_address_response(raw);
  }
  ...
  Payment dco_decode_payment(dynamic raw) {
    ...
    return Payment(
      ...
      preimage: dco_decode_opt_String(arr[6]),
      hash: dco_decode_opt_String(arr[7]),
      txid: dco_decode_opt_String(arr[8]),
  ...
  PaymentRail dco_decode_payment_rail(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return PaymentRail_Onchain();
      case 1:
        return PaymentRail_Invoice();
      case 2:
        return PaymentRail_Offer();
      case 3:
        return PaymentRail_Spontaneous();
      case 4:
        return PaymentRail_WaivedFee();
      case 5:
        return PaymentRail_Unknown(dco_decode_String(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  RevokeClientRequest dco_decode_revoke_client_request(dynamic raw) {
    ...
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return RevokeClientRequest(pubkey: dco_decode_String(arr[0]));
  }
  ...
  Settings dco_decode_settings(dynamic raw) {
    ...
    return Settings(
      ...
      showSplitBalances: dco_decode_opt_box_autoadd_bool(arr[1]),
      skipCancelPaymentConfirm: dco_decode_opt_box_autoadd_bool(arr[2]),
  ...
  UpdateUserSettingsRequest dco_decode_update_user_settings_request(
    ...
    return UpdateUserSettingsRequest(
      preferredFiatCurrency: dco_decode_opt_String(arr[0]),
    );
  }
  ...
  UserSettings dco_decode_user_settings(dynamic raw) {
    ...
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return UserSettings(preferredFiatCurrency: dco_decode_opt_String(arr[0]));
  }
  ...
  WithdrawLnurlRequest dco_decode_withdraw_lnurl_request(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return WithdrawLnurlRequest(
      withdrawRequest: dco_decode_lnurl_withdraw_request(arr[0]),
      amountMsat: dco_decode_CastedPrimitive_u_64(arr[1]),
      description: dco_decode_opt_String(arr[2]),
      personalNote: dco_decode_opt_String(arr[3]),
    );
  }
  ...
  AppData sse_decode_app_data(SseDeserializer deserializer) {
    ...
    var var_preferredFiatCurrency = sse_decode_opt_String(deserializer);
    return AppData(
      humanBitcoinAddress: var_humanBitcoinAddress,
      preferredFiatCurrency: var_preferredFiatCurrency,
    );
  }
  ...
  CancelPaymentRequest sse_decode_box_autoadd_cancel_payment_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_cancel_payment_request(deserializer));
  }
  ...
  sse_decode_box_autoadd_get_human_bitcoin_address_response(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_get_human_bitcoin_address_response(deserializer));
  }
  ...
  RevokeClientRequest sse_decode_box_autoadd_revoke_client_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_revoke_client_request(deserializer));
  }
  ...
  WithdrawLnurlRequest sse_decode_box_autoadd_withdraw_lnurl_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_withdraw_lnurl_request(deserializer));
  }
  ...
  CancelPaymentRequest sse_decode_cancel_payment_request(
    ...
    return CancelPaymentRequest(index: var_index);
  }
  ...
  CreateOfferRequest sse_decode_create_offer_request(
    ...
    var var_minAmountSats = sse_decode_opt_CastedPrimitive_u_64(deserializer);
    var var_description = sse_decode_opt_String(deserializer);
  ...
  GetHumanBitcoinAddressResponse sse_decode_get_human_bitcoin_address_response(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_humanBitcoinAddress = sse_decode_String(deserializer);
  ...
  Offer sse_decode_offer(SseDeserializer deserializer) {
    ...
    var var_minAmountSats = sse_decode_opt_CastedPrimitive_u_64(deserializer);
    var var_bip321AmountSats = sse_decode_opt_CastedPrimitive_u_64(
      deserializer,
    );
    var var_humanBitcoinAddress = sse_decode_opt_String(deserializer);
    ...
    return Offer(
      ...
      expiresAt: var_expiresAt,
      minAmountSats: var_minAmountSats,
      bip321AmountSats: var_bip321AmountSats,
      humanBitcoinAddress: var_humanBitcoinAddress,
      payee: var_payee,
      payeePubkey: var_payeePubkey,
    );
  ...
  sse_decode_opt_box_autoadd_get_human_bitcoin_address_response(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_get_human_bitcoin_address_response(
        deserializer,
      ));
    } else {
      return null;
  ...
  PaymentRail sse_decode_payment_rail(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 5:
        var var_field0 = sse_decode_String(deserializer);
        return PaymentRail_Unknown(var_field0);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  RevokeClientRequest sse_decode_revoke_client_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_pubkey = sse_decode_String(deserializer);
    return RevokeClientRequest(pubkey: var_pubkey);
  }
  ...
  UserSettings sse_decode_user_settings(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_preferredFiatCurrency = sse_decode_opt_String(deserializer);
    return UserSettings(preferredFiatCurrency: var_preferredFiatCurrency);
  }
  ...
  WithdrawLnurlRequest sse_decode_withdraw_lnurl_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_withdrawRequest = sse_decode_lnurl_withdraw_request(deserializer);
    var var_amountMsat = sse_decode_CastedPrimitive_u_64(deserializer);
    var var_description = sse_decode_opt_String(deserializer);
    var var_personalNote = sse_decode_opt_String(deserializer);
    return WithdrawLnurlRequest(
      withdrawRequest: var_withdrawRequest,
  ...
  void sse_encode_app_data(AppData self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_opt_box_autoadd_get_human_bitcoin_address_response(
      self.humanBitcoinAddress,
      serializer,
    );
    sse_encode_opt_String(self.preferredFiatCurrency, serializer);
  }
  ...
  void sse_encode_box_autoadd_cancel_payment_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_cancel_payment_request(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_get_human_bitcoin_address_response(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_get_human_bitcoin_address_response(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_revoke_client_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_revoke_client_request(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_withdraw_lnurl_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_withdraw_lnurl_request(self, serializer);
  }
  ...
  void sse_encode_create_offer_request(
    ...
    sse_encode_opt_CastedPrimitive_u_64(self.minAmountSats, serializer);
    sse_encode_opt_String(self.description, serializer);
  ...
  void sse_encode_get_human_bitcoin_address_response(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.humanBitcoinAddress, serializer);
  ...
  void sse_encode_offer(Offer self, SseSerializer serializer) {
    ...
    sse_encode_opt_CastedPrimitive_u_64(self.minAmountSats, serializer);
    sse_encode_opt_CastedPrimitive_u_64(self.bip321AmountSats, serializer);
    sse_encode_opt_String(self.humanBitcoinAddress, serializer);
  ...
  void sse_encode_opt_box_autoadd_get_human_bitcoin_address_response(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_get_human_bitcoin_address_response(
        self,
        serializer,
      );
    }
  ...
  void sse_encode_payment_rail(PaymentRail self, SseSerializer serializer) {
    ...
    switch (self) {
      ...
      case PaymentRail_Invoice():
        sse_encode_i_32(1, serializer);
      case PaymentRail_Offer():
        sse_encode_i_32(2, serializer);
      case PaymentRail_Spontaneous():
        sse_encode_i_32(3, serializer);
      case PaymentRail_WaivedFee():
        sse_encode_i_32(4, serializer);
      case PaymentRail_Unknown(field0: final field0):
        sse_encode_i_32(5, serializer);
        sse_encode_String(field0, serializer);
    }
  }
  ...
  void sse_encode_withdraw_lnurl_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_lnurl_withdraw_request(self.withdrawRequest, serializer);
    sse_encode_CastedPrimitive_u_64(self.amountMsat, serializer);
    sse_encode_opt_String(self.description, serializer);
    sse_encode_opt_String(self.personalNote, serializer);
  }
}
